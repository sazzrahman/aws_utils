...
sns = SnsWrapper(sns_resource=sns_resource)


# sns.create_topic('clubready-connector-ec2')
topics = list(sns.list_topics())
topic = topics[0]


message = "Sample Job Begin Job Id Time"
attributes = {
    "job": "id-1234",
    "query": "SELECT * FROM dbo.detail",
    "time": "sometime"
}

sns.publish_message(topic=topic,
