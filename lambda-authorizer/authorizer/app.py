...
def lambda_handler(event, context):
    ...
    token = ssm.get_parameter(Name='XPLUS-TOKEN', WithDecryption=True)

    token_value = token.get("Parameter").get("Value") if token else ""
    


    principalId = 'user:prod'
    ...
    if(event['authorizationToken'] == token_value):
